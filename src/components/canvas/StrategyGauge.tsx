...
export default function StrategyGauge({ nodes, edges }: StrategyGaugeProps) {
  ...
  return (
    <div className="absolute left-4 bottom-4 z-30 flex items-center gap-4 rounded-xl border border-border bg-bg-card/95 px-4 py-2.5 shadow-lg backdrop-blur-md">
      {/* Net APY */}
