...
**`POST /api/canvas`** (default base URL: `http://localhost:3000`, override via env `MORPHEUS_BASE_URL` or ask the user for their deployed URL — e.g. `https://morpheus-app.vercel.app`)
